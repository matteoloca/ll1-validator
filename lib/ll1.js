...
function calculateNullables(input) {
  const _calculateNullablesPostcondition = it => {
    if (!(nullableRules.length > 0)) {
      throw new Error("Function \"calculateNullables\" postcondition failed: nullableRules.length > 0");
    }

    if (!(nullableNonTerminals.length > 0)) {
      throw new Error("Function \"calculateNullables\" postcondition failed: nullableNonTerminals.length > 0");
    }

    if (!(nullableRules.length === nullableNonTerminals.length)) {
      throw new Error("Function \"calculateNullables\" postcondition failed: nullableRules.length === nullableNonTerminals.length");
    }
...
function isLL1(input) {
  const _isLL1Postcondition = it => {
    if (!(res === true || res === false)) {
      throw new Error("Function \"isLL1\" postcondition failed: res === true || res === false");
    }
  ...
  if (!(input !== null)) {
    throw new Error("Function \"isLL1\" precondition failed: input !== null");
  }
  ...
  return _isLL1Postcondition(res);
}

function calculateConflicts(nonTerminal, input = {}, lookaheads = {}) {
